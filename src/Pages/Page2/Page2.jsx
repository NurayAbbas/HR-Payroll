...
function Page2() {
  ...
  <div class="page-title">
    <div class="main-top">
      ...
      <div class="latest">
        <span>Tambah Data<FontAwesomeIcon icon={faPlus} /></span>
      </div>
    </div>
  </div>
  ...
  <table class="main-table">
    ...
    <tbody>
      <tr>
        <td>00123</td>
        <td><img src={Ellipse91} alt="profile"/>Davin Putra F</td>
      ...
      <tr>
        <td>00124</td>
        <td><img src={Ellipse92} alt="profile"/>Amalia putri</td>
      ...
      <tr>
        <td>00125</td>
        <td><img src={Ellipse93} alt="profile"/>Sakanti Dwi</td>
        <td>Financial Analyst</td>
        <td>Rp.6.000.000</td>
        <td>Rp. 300.000</td>
        <td>Rp. 300.000</td>
      ...
      <tr>
        <td>00126</td>
        <td><img src={Ellipse94} alt="profile"/>Ria Kusuma</td>
        <td>Sr.UX Designer</td>
        <td>Rp.5.000.000</td>
        <td>Rp. 300.000</td>
        <td>Rp. 300.000</td>
      ...
      <tr>
        <td>00127</td>
        <td><img src={Ellipse9} alt="profile"/>Shofil Fuadi</td>
